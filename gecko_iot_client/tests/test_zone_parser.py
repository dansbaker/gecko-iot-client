...
class TestZoneConfigurationParser(unittest.TestCase):
    ...
    def test_parse_flow_zones(self):
        ...
        zones_config = {
            'flow': {
                ...
                '2': {
                    'name': 'Flow Zone 2',
                    'speed': {'minimum': 0, 'maximum': 100},  # Will use minimum as default
                    'active': False
                }
            }
        }
    ...
    def test_parse_mixed_zone_types(self):
        ...
        zones_config = {
            'flow': {
                '1': {'name': 'Flow Zone', 'speed': 25, 'active': True}
            },
            'lighting': {
                '1': {'name': 'Light Zone', 'active': False}
            },
            'temperatureControl': {
                '1': {'name': 'Temp Zone', 'set_point': 22.0}
            }
        }
    ...
    def test_parse_with_invalid_zone_data(self):
        ...
        zones_config = {
            'flow': {
                '1': {'name': 'Valid Zone', 'speed': 50, 'active': True},
                '2': {'speed': 'invalid_speed_value'}  # This will cause validation error
            }
        }
    ...
    def test_zone_type_mapping(self):
        ...
        self.assertEqual(
            self.parser.ZONE_TYPES['flow'], 
            ZoneType.FLOW_ZONE
        )
        self.assertEqual(
            self.parser.ZONE_TYPES['lighting'], 
    ...
    def test_logging_calls(self, mock_logger):
        ...
        zones_config = {
            'flow': {
                '1': {'name': 'Test Zone', 'speed': 50, 'active': True}
            }
        }
